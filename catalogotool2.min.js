window.agregarBotonera=function(){replicarNodo(qs("#btn-show-more"));let e=qs("#btn-show-more");e.innerText="Ver "+limiteReducido+" Más";e.addEventListener("click",verArticulos.bind(this,limiteReducido));let t=e.cloneNode(true);t.innerText="Ver "+limiteAmpliado+" Más";t.id="btn-show-much-more";t.addEventListener("click",verArticulos.bind(this,limiteAmpliado));e.parentNode.append(t);let o=qs("#available").parentNode;o.className="form-group col-xs-6 col-md-2";replicarNodo(o);o=qs("#available").parentNode;o.querySelector("label").htmlFor="available";let a=document.createElement("div");a.className="form-group col-xs-6 col-md-2";o.parentNode.append(a);let r=document.createElement("span");r.className="btn btn-outline";r.innerText="Buscar "+limiteReducido;r.id="boton-buscar-limite";a.append(r);r.addEventListener("click",reemplazarDisponibles.bind(this,limiteReducido));let s=document.createElement("div");s.className="form-group col-xs-6 col-md-2";o.parentNode.append(s);let i=document.createElement("span");i.className="btn btn-outline";i.innerText="Buscar Todo";i.id="boton-buscar-todo";s.append(i);i.addEventListener("click",reemplazarDisponibles.bind(this,0));let l=qs("#plf").parentNode;replicarNodo(l);let n=qs("#category").parentNode;qs("#category").style.display=null;bsmultiselect=qs(".dashboardcode-bsmultiselect");if(bsmultiselect){bsmultiselect.remove()}opciontodos=qs("#category option[value='all']");if(opciontodos){opciontodos.remove()}replicarNodo(n.parentNode);qs("#category option[value='home']").selected=true;qs("#category option[value='child']").selected=true;qs("#category option[value='sport']").selected=true;$("#category.form-control").bsMultiSelect();qs("#home").remove();qs("#child").remove();qs("#sport").remove();let c=o.cloneNode(true);let d=c.querySelector("input");d.name="caducahoy";d.id="caducahoy";d.checked=false;let u=c.querySelector("label");u.textContent="Caducan hoy:";u.htmlFor="caducahoy";o.parentNode.append(c);$("#caducahoy").on("click",fncFiltrarCaducanHoy);let p=o.cloneNode(true);let m=p.querySelector("input");m.name="invertir";m.id="invertir";m.checked=false;let b=p.querySelector("label");b.textContent="Orden inverso:";b.htmlFor="invertir";o.parentNode.append(p);$("#invertir").on("click",fncInvertirOrden);let f=document.createElement("div");f.className="form-group col-xs-6 col-md-2";o.parentNode.append(f);let v=document.createElement("span");v.className="btn btn-outline";v.id="boton-auto-refrescar";v.innerText="Auto Refrescar";f.append(v);v.addEventListener("click",iniciarAutoRefrescar);let h=document.createElement("div");h.className="form-group col-xs-6 col-md-2";o.parentNode.append(h);let q=document.createElement("span");q.className="btn btn-outline";q.id="boton-auto-capturar";q.innerText="Auto Capturar";h.append(q);q.addEventListener("click",iniciarAutoCapturar);let w=document.createElement("style");w.innerHTML=`#results{display:flex;flex-direction:row;flex-wrap:wrap;}
