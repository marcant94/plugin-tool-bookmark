...
@media only screen and (max-width:768px){#results>div{flex-basis:100%;padding:2px;}}`,document.getElementsByTagName("head")[0].appendChild(e)},window.borrarResultados=function(){var t=qsa("#results>div");for(let e=0;e<t.length;e++)t[e].remove();var e=qs("#caducahoy"),e=(e&&null!=e&&(e.checked=!1),qs("#invertir"));e&&null!=e&&(e.checked=!1)},window.reemplazarDisponibles=function(e){borrarResultados(),verArticulos(e)},window.iniciarAutoRefrescar=async function(){qs("#boton-auto-refrescar").classList.add("bloqueado"),comprobarReservaCatalogo()},window.iniciarAutoCapturar=async function(){qs("#boton-auto-capturar").classList.add("bloqueado"),comprobarReservaCatalogo(!0)},window.comprobarReservaCatalogo=async function(e=!1){let t=webActual,o=!1;var a=qs("#plf").value;"none"!=a&&0<a&&(o?t+="&":(o=!0,t+="?"),t+="plf_id="+a);qsa("#category option").forEach(e=>{e.selected&&(o?t+="&":(o=!0,t+="?"),t=(t+="category="+e.value)+"&"+e.value+"=on")});a=qs("#available").checked;1==a&&(o?t+="&":(o=!0,t+="?"),t+="available="+a);var a=await(await fetch(t)).text(),n=a.indexOf("antiquity/favorite"),r=a.substring(0,n),r=(comprobarLogin(r),r.includes("Reservar")),n=a.substring(n+19),n=parseInt(n.substring(0,n.indexOf('" method="POST"')));if(chks++,r&&n>idPrimerArticulo){idPrimerArticulo=n;var r=a.indexOf('<div class="row" id="results">'),i=a.indexOf('<div class="row">',r+30),a=a.substring(r,i),r=qs("#invertir");r&&null!=r&&(r.checked=!1),qs("#results").outerHTML=a,1==e&&qs("#results .thumbnail-container form[action$='"+n+"'] button").click()}else{try{(tituloCatalogo=qs(".container .row h1")).textContent=textoTituloCatalogo+" - "+chks}catch(e){}try{document.title=ttl+" "+chks}catch(e){}}setTimeout(comprobarReservaCatalogo,timeout)},1!=window.pulsado&&(resultadosCatalogo=qs("#results"))&&(textoTituloCatalogo=qs(".container .row h1").textContent,null==qs("#caducahoy")&&agregarBotonera(),reemplazarDisponibles(limiteReducido),window.pulsado=!0);