...
@media only screen and (max-width:768px){#results>div{flex-basis:100%;padding:2px;}}`,document.getElementsByTagName("head")[0].appendChild(e)},window.borrarResultados=function(){var t=qsa("#results>div");for(let e=0;e<t.length;e++)t[e].remove();var e=qs("#caducahoy"),e=(e&&null!=e&&(e.checked=!1),qs("#invertir"));e&&null!=e&&(e.checked=!1)},window.reemplazarDisponibles=function(e){borrarResultados(),verArticulos(e)},window.iniciarAutoActualizar=async function(){qs("#boton-auto-actualizar").classList.add("bloqueado"),comprobarReservaCatalogo()},window.comprobarReservaCatalogo=async function(){let t=webActual,o=!1;var e=qs("#plf").value;"none"!=e&&0<e&&(o?t+="&":(o=!0,t+="?"),t+="plf_id="+e);qsa("#category option").forEach(e=>{e.selected&&(o?t+="&":(o=!0,t+="?"),t=(t+="category="+e.value)+"&"+e.value+"=on")});e=qs("#available").checked;1==e&&(o?t+="&":(o=!0,t+="?"),t+="available="+e);var e=await(await fetch(t)).text(),a=e.indexOf("antiquity/favorite"),n=e.substring(0,a),n=(comprobarLogin(n),n.includes("Reservar")),a=e.substring(a+19),a=parseInt(a.substring(0,a.indexOf('" method="POST"')));if(chks++,n&&a>idPrimerArticulo){idPrimerArticulo=a;n=e.indexOf('<div class="row" id="results">'),a=e.indexOf('<div class="row">',n+30),e=e.substring(n,a),n=qs("#invertir");n&&null!=n&&(n.checked=!1),qs("#results").outerHTML=e}else{try{(tituloCatalogo=qs(".container .row h1")).textContent=textoTituloCatalogo+" - "+chks}catch(e){}try{document.title=ttl+" "+chks}catch(e){}}setTimeout(comprobarReservaCatalogo,timeout)},1!=window.pulsado&&(resultadosCatalogo=qs("#results"))&&(textoTituloCatalogo=qs(".container .row h1").textContent,null==qs("#caducahoy")&&agregarBotonera(),reemplazarDisponibles(limiteReducido),window.pulsado=!0);